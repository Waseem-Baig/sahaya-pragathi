...
export default function Dashboard() {
  ...
  const kpiData = [
    { title: 'Total Grievances', value: 1234, change: '+12', period: 'this month', trend: 'up' as const },
    { title: 'Resolved Cases', value: 892, change: '+8', period: 'this month', trend: 'up' as const },
    { title: 'SLA Compliance', value: 87, change: '-3', period: 'this month', trend: 'down' as const, suffix: '%' },
    { title: 'Avg Resolution Time', value: 2.3, change: '-0.5', period: 'this month', trend: 'up' as const, suffix: ' days' },
  ];
